                ...
                <nav class="tree-menu">
                  <div class="left-menu-inner">
                    ...
                    <ul class="menu-column menu-prev sport-type-Football">
                      ...
                      <li><a href="{{route('football-frontend')}}" class="link-lvl-prev"><i class="fas fa-chevron-circle-left"></i> <span class="link-name">Previous</span></a></li>
                    </ul>
                  </div>
                </nav>
              </aside>
            ...
            <div class="sports-wrapper">
              <div class="events">
                <div class="all-details-pages-live-data">
                  <img src="{{asset('frontend/assets/images/Football_images.png')}}" alt="" class="img-fluid" />
                </div>
